...
public class Opskrift {
    ...
    public Opskrift(int id, String name, String linkToPage, int time, String procedure, boolean hasMade) {
        setId(id);
        setName(name);
    ...
    public Opskrift(String name, String linkToPage, int time, String procedure, boolean hasMade) {
    setName(name);
    setLinkToPage(linkToPage);
    setTime(time);
    setProcedure(procedure);
    ...
    public String toString() {
        return String.format(
                "Opskrift{id=%d, name='%s', linkToPage='%s', time=%d, procedure='%s', hasMade=%s}", id, name,
